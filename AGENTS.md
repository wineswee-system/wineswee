...
This project is indexed by GitNexus as **sme-ops-system** (23332 symbols, 31647 relationships, 124 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
