...
This project is indexed by GitNexus as **sme-ops-system** (15233 symbols, 20538 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
