...
This project is indexed by GitNexus as **sme-ops-system** (25650 symbols, 34816 relationships, 131 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
