...
This project is indexed by GitNexus as **sme-ops-system** (21362 symbols, 28994 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
