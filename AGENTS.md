...
This project is indexed by GitNexus as **sme-ops-system** (20135 symbols, 27360 relationships, 79 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
