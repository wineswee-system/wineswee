...
This project is indexed by GitNexus as **sme-ops-system** (16856 symbols, 22903 relationships, 69 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
