...
This project is indexed by GitNexus as **sme-ops-system** (20991 symbols, 28512 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
