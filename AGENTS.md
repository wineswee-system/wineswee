...
This project is indexed by GitNexus as **sme-ops-system** (21095 symbols, 28634 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
