...
This project is indexed by GitNexus as **sme-ops-system** (24122 symbols, 32823 relationships, 127 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
