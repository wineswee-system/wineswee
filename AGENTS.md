...
This project is indexed by GitNexus as **sme-ops-system** (24070 symbols, 32738 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
