...
This project is indexed by GitNexus as **sme-ops-system** (22451 symbols, 30373 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
