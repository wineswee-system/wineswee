...
This project is indexed by GitNexus as **sme-ops-system** (24591 symbols, 33392 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
