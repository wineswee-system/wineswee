...
This project is indexed by GitNexus as **sme-ops-system** (22990 symbols, 31049 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
