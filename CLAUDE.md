...
This project is indexed by GitNexus as **sme-ops-system** (20807 symbols, 28278 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
