...
This project is indexed by GitNexus as **sme-ops-system** (17143 symbols, 23320 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
