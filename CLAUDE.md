...
This project is indexed by GitNexus as **sme-ops-system** (24601 symbols, 33401 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
