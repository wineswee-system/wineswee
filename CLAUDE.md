...
This project is indexed by GitNexus as **sme-ops-system** (21376 symbols, 29016 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
