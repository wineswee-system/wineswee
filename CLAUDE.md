...
This project is indexed by GitNexus as **sme-ops-system** (25704 symbols, 34891 relationships, 133 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
