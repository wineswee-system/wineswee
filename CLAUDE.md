...
This project is indexed by GitNexus as **sme-ops-system** (21017 symbols, 28542 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
