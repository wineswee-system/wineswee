...
This project is indexed by GitNexus as **sme-ops-system** (19659 symbols, 26714 relationships, 78 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
