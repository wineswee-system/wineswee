...
This project is indexed by GitNexus as **sme-ops-system** (20086 symbols, 27308 relationships, 85 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
