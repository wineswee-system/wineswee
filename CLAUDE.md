...
This project is indexed by GitNexus as **sme-ops-system** (19581 symbols, 26615 relationships, 78 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
