...
This project is indexed by GitNexus as **sme-ops-system** (18329 symbols, 24909 relationships, 72 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
