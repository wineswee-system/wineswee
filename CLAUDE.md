...
This project is indexed by GitNexus as **sme-ops-system** (23682 symbols, 32149 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
