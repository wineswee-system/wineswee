...
This project is indexed by GitNexus as **sme-ops-system** (22472 symbols, 30382 relationships, 98 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
