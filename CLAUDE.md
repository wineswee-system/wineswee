...
This project is indexed by GitNexus as **sme-ops-system** (21022 symbols, 28548 relationships, 100 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
