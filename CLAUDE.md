...
This project is indexed by GitNexus as **sme-ops-system** (25631 symbols, 34792 relationships, 131 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
