...
This project is indexed by GitNexus as **sme-ops-system** (16961 symbols, 23060 relationships, 64 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
