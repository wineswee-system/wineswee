-- =============================================
-- 永春店 2026/04 schedules + attendance 匯入 (V2 安全版)
-- 自動產生 by scripts/gen_yongchun_data_only.mjs
--
-- 前提：以下 7 員工必須已存在於 employees 表（store_id=31）：
--   陳嘉益 / 許亦翎 / 徐宥芯 / 洪瑛妏 / 蔡伊真 / 林思妤 / 陳姿螢
-- =============================================
...
BEGIN
  ...
  -- 檢查 7 員工是否都存在
  IF (SELECT COUNT(*) FROM employees WHERE name = ANY(ARRAY['陳嘉益','許亦翎','徐宥芯','洪瑛妏','蔡伊真','林思妤','陳姿螢']) AND organization_id = v_org_id) < 7 THEN
    RAISE EXCEPTION '7 員工沒到齊，先跑 rebuild SQL';
  END IF;

  -- 清掉 4 月既有資料（idempotent）
  DELETE FROM schedules WHERE date >= DATE '2026-04-01' AND date <= DATE '2026-04-30'
    AND employee_id IN (SELECT id FROM employees WHERE name = ANY(ARRAY['陳嘉益','許亦翎','徐宥芯','洪瑛妏','蔡伊真','林思妤','陳姿螢']) AND organization_id = v_org_id);
  ...
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-01', '11-20', NULL, NULL, '2026-04'
  ...
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-02', '巡店', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-03', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-04', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-05', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-06', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-07', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-08', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-09', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-10', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-11', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-12', '巡店11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-13', '六張犁17-24', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-14', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-15', '六張犁15-24', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-16', '六張犁15-24', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-17', '16-01', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-18', '13-22', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-19', '15-24', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-20', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-21', '11-20', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-22', '巡店13-22', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-23', '13-22', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-24', '13-22', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-25', '六張犁11-13', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-26', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-27', '13-22', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-28', '六張犁15-24', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-29', '11-24', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '陳嘉益', id, DATE '2026-04-30', '16-01', NULL, NULL, '2026-04'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
  ...
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-01', '19-00', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-02', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-03', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-04', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-05', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-06', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-07', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-08', '19-00', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-09', '19-00', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-10', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-11', '19-01', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-12', '19-00', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-13', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-14', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-15', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-16', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-17', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-18', '19-01', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-19', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-20', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-21', '六張犁19-00', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-22', '六張犁19-00', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-23', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-24', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-25', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-26', '15-22', NULL, NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-27', '六張犁19-00', NULL, '六張犁', '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-28', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-29', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
    SELECT '洪瑛妏', id, DATE '2026-04-30', '休', '休', NULL, '2026-04'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id
  ON CONFLICT (employee, date) DO UPDATE SET shift = EXCLUDED.shift, absence_type = EXCLUDED.absence_type, source_store = EXCLUDED.source_store, month_group = EXCLUDED.month_group;
  INSERT INTO schedules (employee, employee_id, date, shift, absence_type, source_store, month_group)
  ...
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-01', '10:51:13', '20:00:42', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-02', '10:50:52', '20:00:00', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-03', '11:00:00', '20:01:55', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-04', '11:00:00', '20:07:50', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-06', '10:55:30', '20:02:07', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-07', '15:00:00', '21:03:02', 6, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-09', '10:53:31', '20:13:28', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-10', '10:54:42', '20:09:09', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-11', '10:53:11', '20:37:38', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-12', '10:47:42', '20:06:13', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-13', '16:49:02', '00:03:38', 7, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-15', '14:54:22', '00:00:00', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-16', '14:59:19', '00:07:33', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-17', '15:46:05', '02:16:01', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-18', '12:53:44', '22:19:45', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-19', '14:44:39', '00:34:14', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-21', '11:00:35', '21:03:00', 7.99, TRUE, 1, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-22', '12:52:21', '22:02:04', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-23', '12:51:20', '00:02:09', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-24', '11:00:08', '22:16:13', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-25', '11:00:03', '13:04:19', 2, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-27', '12:55:45', '22:06:42', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-28', '14:41:05', '00:00:11', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-29', '10:55:13', '02:30:44', 12, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '陳嘉益', id, v_store_id, DATE '2026-04-30', '15:59:57', '01:04:02', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '陳嘉益' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
  ...
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '徐宥芯', id, v_store_id, DATE '2026-04-30', '10:32:26', '21:41:49', 8, FALSE, 0, '正常'
      FROM employees WHERE name = '徐宥芯' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-01', '19:00:00', '00:06:56', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-08', '19:00:13', '00:11:34', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-09', '18:55:51', '00:05:45', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-11', '19:00:09', '01:03:47', 6, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-12', '19:00:17', '00:30:05', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-18', '19:00:14', '01:08:26', 6, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-21', '19:00:06', '00:23:41', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-22', '19:00:05', '00:10:24', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-26', '14:59:49', '22:01:08', 7, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
    SELECT '洪瑛妏', id, v_store_id, DATE '2026-04-27', '19:00:00', '00:04:33', 5, FALSE, 0, '正常'
      FROM employees WHERE name = '洪瑛妏' AND organization_id = v_org_id;
  INSERT INTO attendance_records (employee, employee_id, store_id, date, clock_in, clock_out, total_hours, is_late, late_minutes, status)
  ...
  RAISE NOTICE '永春 4 月 schedules + attendance 匯入完成';
END $$;

COMMIT;

-- 驗證
SELECT e.name, COUNT(*) AS days, ROUND(SUM(ar.total_hours), 2) AS total_hours
