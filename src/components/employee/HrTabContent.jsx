      ...
      {subTab === 'salary' && (
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 1fr', gap: 12 }}>
            ...
            <div><div style={L}>職務津貼</div><input className="form-input" type="number" style={{ width: '100%' }} placeholder="0" value={form.role_allowance || ''} onChange={e => set('role_allowance', e.target.value)} /></div>
