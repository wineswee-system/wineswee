...
const helpCategories = [
  ...
  },
  {
    icon: '💳', title: '財務會計', articles: [
      ...
      { title: '費用申請與核銷(驗收)流程', views: 178 },
      { title: '費用核銷(驗收)簽核鏈設定', views: 165 },
...
const FAQ_ITEMS = [
  ...
  { q: '如何設定費用申請的簽核鏈？', a: '前往「財務 > 費用核銷(驗收)簽核設定」，可依申請金額區間設定不同審核人與多層步驟。啟用/停用規則無需刪除。' },
  { q: '費用申請送出後如何追蹤進度？', a: '在「費用核銷(驗收)」列表中可看到目前所在簽核步驟，被駁回時會顯示駁回原因，可直接修改後重新送審。' },
