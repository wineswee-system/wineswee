...
export default function LeaveCalendar() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      supabase.from('employees').select('id, name, dept, department_id, position, departments!department_id(name)').eq('status', '在職').not('is_archived', 'is', true).order('department_id').order('name'),
