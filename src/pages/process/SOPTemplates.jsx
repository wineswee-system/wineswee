...
const DEFAULT_TEMPLATES = [
  {
    name: '新人到職 SOP',
    category: 'HR',
    description: '新進員工到職標準流程，從報到到獨立上線（10 步）',
    steps: [
      { title: '人事資料建檔', role: 'HR', priority: '高', description: '身分證影本、存摺影本、勞保加保、薪轉帳戶設定' },
      { title: '設備與帳號開通', role: 'IT', priority: '高', description: 'Email、系統帳號、POS 權限、LINE 群組加入' },
      { title: '工作環境介紹', role: '主管', priority: '中', description: '辦公區導覽、設備使用說明、安全逃生路線' },
      { title: '公司制度說明', role: 'HR', priority: '中', description: '出勤規則、請假流程、薪資結構、福利制度' },
      { title: '部門團隊介紹', role: '主管', priority: '中', description: '團隊成員認識、工作職掌說明、直屬主管確認' },
      { title: '門市 SOP 教學', role: '主管', priority: '高', description: '開店/關店流程、收銀操作、客服應對話術' },
      { title: 'POS 系統實操訓練', role: 'IT', priority: '高', description: '點餐、結帳、退貨、庫存查詢操作練習' },
      { title: '食安與衛生訓練', role: '主管', priority: '高', description: '食品安全法規、清潔消毒流程、過期品處理' },
      { title: '實習跟班（3天）', role: '主管', priority: '中', description: '跟隨資深同仁實習，熟悉日常作業流程' },
      { title: '獨立上線確認', role: '主管', priority: '高', description: '主管確認可獨立作業、發放正式工作證、結束試用期' },
    ],
  },
  {
    name: '每月盤點 SOP',
    ...
    steps: [
      { title: '盤點日期通知', role: '主管', priority: '中', description: '提前 3 天通知各門市盤點時間，暫停進出貨' },
      { title: '列印盤點表', role: '倉管', priority: '中', description: '從系統匯出目前庫存清單，列印盤點用紙本表格' },
      { title: '實際數量清點', role: '倉管', priority: '高', description: '逐項清點實際庫存數量，記錄在盤點表上' },
      { title: '差異比對', role: '倉管', priority: '高', description: '系統帳面數量與實際數量比對，標記差異項目' },
      { title: '差異原因調查', role: '主管', priority: '高', description: '調查差異原因：損耗、失竊、系統錯誤、進出貨未登記' },
      { title: '庫存調整', role: '倉管', priority: '中', description: '依調查結果在系統中進行庫存調整，填寫異動原因' },
      { title: '盤點報告產出', role: '倉管', priority: '中', description: '彙整盤點結果，產出差異報告，計算盤差率' },
      { title: '主管審核簽核', role: '主管', priority: '高', description: '主管審閱盤點報告，確認調整合理，簽核歸檔' },
    ],
  },
  {
    name: '客訴處理 SOP',
    ...
    steps: [
      { title: '接收客訴', role: '客服', priority: '高', description: '記錄客訴內容、客戶資訊、發生時間地點、訴求' },
      { title: '初步安撫', role: '客服', priority: '高', description: '向客戶致歉、表達重視、告知處理時程' },
      { title: '事件調查', role: '主管', priority: '高', description: '了解事件經過、調閱監視器、訪談當事人' },
      { title: '擬定解決方案', role: '主管', priority: '中', description: '依客訴性質擬定賠償/補救方案，報請上級核准' },
      { title: '回覆客戶', role: '客服', priority: '高', description: '致電或訊息通知客戶處理結果，執行補救方案' },
      { title: '內部檢討改善', role: '主管', priority: '中', description: '召開檢討會議，找出根本原因，制定預防措施' },
      { title: '結案歸檔', role: '客服', priority: '低', description: '更新客訴紀錄狀態為已結案，歸檔備查' },
    ],
  },
  {
    name: '採購申請 SOP',
    category: '採購',
    description: '設備與原物料採購標準流程（8 步），從需求到驗收',
    steps: [
      { title: '需求提出', role: '申請人', priority: '中', description: '填寫採購需求單：品項、數量、規格、預算、期望交期' },
      { title: '主管審核', role: '主管', priority: '中', description: '確認需求合理性、預算額度、是否有替代方案' },
      { title: '供應商詢價', role: '採購', priority: '中', description: '向 2-3 家供應商詢價，取得報價單比較' },
      { title: '比價與議價', role: '採購', priority: '中', description: '比較價格、品質、交期、付款條件，選定供應商' },
      { title: '下單採購', role: '採購', priority: '高', description: '開立採購單、確認交期、付款方式' },
      { title: '到貨驗收', role: '倉管', priority: '高', description: '核對品項、數量、品質，填寫驗收單' },
      { title: '入庫上架', role: '倉管', priority: '中', description: '系統入庫、貼標籤、放置指定儲位' },
      { title: '請款付款', role: '財務', priority: '中', description: '核對發票與驗收單，安排付款' },
    ],
  },
  {
    name: '新店開幕 SOP',
    category: '展店',
    description: '開設新分店完整標準作業流程（15 步），涵蓋選址、法規、裝潢、設備、人員、庫存、行銷、開幕',
    steps: [
      { title: '場地評估與選址', role: '主管', priority: '高', description: '商圈分析、人流評估、租金比較、競品調查，產出選址報告' },
      { title: '租約簽訂', role: '主管', priority: '高', description: '與房東議價、審閱合約條款、確認租期與押金、簽約用印' },
      { title: '營業登記與許可證', role: '行政', priority: '高', description: '辦理營業登記、消防安檢申請、衛生許可證、招牌廣告許可' },
      { title: '裝潢設計圖確認', role: '主管', priority: '高', description: '與設計師確認平面圖、施工圖、材料選擇、品牌視覺規範' },
      { title: '裝潢工程發包施工', role: '採購', priority: '高', description: '廠商比價、發包簽約、施工進度追蹤、每週工程會議' },
      { title: 'POS / 監視器 / 設備採購', role: '採購', priority: '高', description: 'POS 系統安裝測試、監視器佈線、冷藏冷凍設備、桌椅燈具' },
      { title: '水電工程驗收', role: '採購', priority: '中', description: '水電管線測試、消防設備檢查、空調試運轉、缺失改善' },
      { title: '張貼職缺 / 面試', role: 'HR', priority: '中', description: '依編制人數開缺、發布 104/LINE 招募、安排面試、錄取通知' },
      { title: '新人教育訓練', role: 'HR', priority: '中', description: '公司制度說明、門市 SOP 教學、POS 操作訓練、服務禮儀演練' },
      { title: '供應商簽約', role: '採購', priority: '中', description: '原物料供應商比價、簽訂合約、確認配送頻率與最低訂購量' },
      { title: '首批進貨 / 庫存建置', role: '倉管', priority: '中', description: '依開店清單備貨、驗收入庫、系統建檔、設定安全庫存量' },
      { title: '陳列上架', role: '倉管', priority: '中', description: '商品陳列規劃、貨架標價、POP 佈置、動線確認' },
      { title: '行銷活動規劃', role: '行銷', priority: '中', description: '開幕優惠方案、社群宣傳、LINE 推播、傳單/布條製作' },
      { title: '內部試營運（3天）', role: '主管', priority: '高', description: '邀請內部人員模擬消費、測試點餐/結帳/出餐流程、記錄問題並修正' },
      { title: '正式開幕', role: '主管', priority: '高', description: '開幕活動執行、媒體/部落客邀請、首日營運數據追蹤、開幕檢討會議' },
    ],
  },
]
