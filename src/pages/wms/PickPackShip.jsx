...
export default function PickPackShip() {
  ...
  return (
    <div className="fade-in">
      ...
      {/* Create Pick Modal */}
      {showCreatePick && (
        <div style={{ position: 'fixed', inset: 0, background: 'var(--bg-modal-overlay)', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={() => setShowCreatePick(false)}>
