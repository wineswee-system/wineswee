-- ============================================================
-- 取代 20260508030000 + 040000 + 050000：因為 030000 失敗 rollback 後
-- target_store_id / target_section_id / form_chain_configs / RPCs 都沒建成。
-- 這支 migration 從頭做完整套，全部 idempotent。
-- ============================================================
...
-- ═══ 8. RPC resolve_chain_step_approvers ═══
...
-- ═══ 9. RPC preview_chain_step_target ═══
