-- ════════════════════════════════════════════════════════════════════════════
-- form_submissions chain advance Phase 2 (2/3):
--   web_list_my_pending_approval_ids 1:1 重寫 + 加 form_submissions 區段
-- ────────────────────────────────────────────────────────────────────────────
-- 切檔原因：avoid deadlock with 1/3 (ash trigger) 同檔跑
-- 只 CREATE OR REPLACE FUNCTION，不動 table → 拿 function lock 即可
-- ════════════════════════════════════════════════════════════════════════════
