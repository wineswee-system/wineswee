-- ════════════════════════════════════════════════════════════════════════════
-- Fix: liff_expense_dashboard — accounts 用了 PostgreSQL 不支援的
--      json_agg(DISTINCT ... ORDER BY ...) 語法 → 改成 subquery DISTINCT
-- ════════════════════════════════════════════════════════════════════════════
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    -- ── 科目清單（改用 DISTINCT 子查詢，避免 json_agg(DISTINCT ... ORDER BY) 語法錯）
    'accounts', (
