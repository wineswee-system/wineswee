-- 計薪加入「遲到/早退」per-minute 扣項
-- 2026-06-17  函式本體複製自 20260617110000,只加遲到/早退邏輯(門市讀班表actual_start/end、行政固定、計件不扣)
-- 遲到/早退 = 分鐘 × 時薪/60;門市無寬限、行政寬限到09:30最晚18:30;跨午夜+1440;早打卡不給credit。
BEGIN;
