-- ════════════════════════════════════════════════════════════════════════════
-- 入帳 generate_payroll：所得稅不代扣（v_income_tax 設 0）
-- 2026-06-25  老闆政策：不代扣所得稅，跟試算(incomeTax=0)一致。
-- 以 live 版（_dump_function_defs）為基準，只改 v_income_tax 那一行，其餘逐字不動。
-- ⚠️ 入帳的 OT / 遲到早退仍是舊算法(待 B2 對齊)，正式結算前仍須做 B2。
-- ════════════════════════════════════════════════════════════════════════════
