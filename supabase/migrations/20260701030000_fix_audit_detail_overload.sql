-- ════════════════════════════════════════════════════════════════════════════
-- 修正 liff_get_store_audit_detail：_employee_matches_chain_step overload 歧義
-- Line 71 的 3-arg 呼叫在 4-param 版本存在時有 42725 ambiguity
-- 修法：加 ::int cast + FALSE 第四參數，明確命中 4-param overload
-- ════════════════════════════════════════════════════════════════════════════
