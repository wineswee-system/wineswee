-- 修正游承軒(405)跨午夜晚班打卡 — 2026-07-15
-- 原誤打成 7/15 00:04(只有上班);應為 7/14 18:00~00:00(午夜)。
...
UPDATE public.attendance_records
 ...
 WHERE id = 3795 AND employee_id = 405;
...
SELECT 3795, '游承軒', '2026-07-14', '00:04:00', '18:00:00', NULL, '00:00:00',
       '修正跨午夜晚班打卡(誤打成7/15凌晨→7/14 18:00~00:00)', 'system(migration)', 1
WHERE NOT EXISTS (
  SELECT 1 FROM public.attendance_clock_edits
  WHERE attendance_record_id = 3795 AND reason LIKE '修正跨午夜晚班打卡%');
