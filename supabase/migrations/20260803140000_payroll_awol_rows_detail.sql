-- 計薪引擎:曠職明細回傳日期清單 _awol_rows — 2026-08-03
-- ════════════════════════════════════════════════════════════════════════════
-- 曠職扣款已生效,但公式視窗只顯示天數/金額、沒列是哪幾天。補回傳 _awol_rows(日期陣列),
-- 判準與 v_awol_days 完全一致(admin+in_payroll、週一~五、非國定假/天災、無打卡/請假/出差)。
-- 純新增回傳欄位,不動任何金額計算。dump live 後單點插入,其餘逐字保留。idempotent。
-- ════════════════════════════════════════════════════════════════════════════
