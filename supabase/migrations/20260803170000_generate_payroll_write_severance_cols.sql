-- 修:generate_payroll 入帳時把資遣費列項寫進 payroll_records — 2026-08-03
-- ============================================================================
-- 承 20260803160000(引擎 B3 還原資遣費、回傳 severance 欄)。generate 的 gross_salary 已用引擎
-- gross(內含資遣費,line: v_gross:=(v_j->>'gross'))→ 淨額正確;但 INSERT 沒寫 severance_amount/
-- notice_wage/severance_total/severance_record_id 這幾欄 → 薪資單/報表看不到「資遣費」列項。
-- 這裡把這 4 欄補進 INSERT(值取自引擎回傳,不動 gross,不會重複計)。DB dump 後單點取代 2 處。
-- ============================================================================
