-- 2026-08-14 liff_insert_expense_request 加 repair_order_id 透傳(維修單自動綁定;一般費用不傳=null不變)
...
BEGIN
  ...
  INSERT INTO public.expense_requests (
    ...
    linked_binding_id, repair_order_id,
  ...
  VALUES (
    ...
    p_payload->>'supplier',
    v_items,
    p_binding_id, NULLIF(p_payload->>'repair_order_id','')::int,
    '申請中',
    emp.organization_id,
