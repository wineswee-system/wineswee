-- 2026-09-07 曠職判定放寬:有「上班或下班」任一打卡就不算曠職(修夜班漏打上班卡被誤扣曠職)
-- 引擎兩處曠職條件 ar.clock_in IS NOT NULL → (ar.clock_in IS NOT NULL OR ar.clock_out IS NOT NULL)。以 pg_get_functiondef 程式替換,其餘不動。
